...
function selectFundInfo(){
	var url = "<%=request.getContextPath() %>/fundHolding/selectForPageList";
...
function selectFundAccount(){
	var url = "<%=request.getContextPath() %>/fundHolding/selectForAccountList";
	window.open(url,"","dialogWidth=500px;dialogHeight=800px");
}
...
**/
	...
	<body class="main_body">
		<form name="subForm" id="subForm"
			action="<%=request.getContextPath()%>/fundHolding/addSave" method="post" >
					...
					<td width="255" height="24" colspan="4" class="bline">
						<table width="800" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td>
									<input name="amount" type="number"  id="amount" maxlength="11"
										size="30" required />
