...
<form name="subForm" id="subForm"  action="<%=request.getContextPath() %>/fundinfo/editSave" method="post" onSubmit="return checkSubmit()">
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td width="60%" height="30"><IMG height=14 src="<%=request.getContextPath() %>/static/images/book1.gif" width=20>&nbsp;<u>修改基金</u></td>
  ...
  <table width="98%"  border="0" align="center" cellpadding="2" cellspacing="2" id="needset" style="border:1px solid #cfcfcf;background:#ffffff;">
    <tr>
      <td width="255" height="24" colspan="4" class="bline"><table width="800" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td><input name="name" type="text" id="name" maxlength="64" size="30"  required value="${item.name }" onblur="this,name"/>&nbsp;&nbsp;<span style="color:red;">*</span>
          </td>
        </tr>
      </table></td>
    </tr>
     <tr>
      <td width="255" height="24" colspan="4" class="bline"><table width="800" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td><input name="price" type="number" id="price" maxlength="11" size="30" value="${item.price }"  required  style="height: 20px;width: 186px" />&nbsp;&nbsp;<span style="color:red;">*</span>
          </td>
        </tr>
      </table></td>
    </tr>
    <tr>
      <td width="255" height="24" colspan="4" class="bline"><table width="800" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td>
           <input name="description" type="text" id="description"  size="30"  value="${item.description }"  required/>&nbsp;&nbsp;<span style="color:red;">*</span>
          </td>
        </tr>
      </table></td>
    </tr>
    <tr>
      <td width="255" height="24" colspan="4" class="bline"><table width="800" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td>
           <r:htmlRadio type="F_STATUS" id="status" name="status" value="${item.status}" html="onclick='test(111)'"/>&nbsp;&nbsp;<span style="color:red;">*</span>
          </td>
        </tr>
      </table></td>
    </tr>
    <tr>
      <td width="255" height="24" colspan="4" class="bline"><table width="800" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="150" align="right">&nbsp;发行方：</td>
          <td>
          ${item.issue.issueName }
          </td>
        </tr>
      </table></td>
    </tr>
