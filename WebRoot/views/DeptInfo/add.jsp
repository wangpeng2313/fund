...
<script type="text/javascript">
  ...
  <form name="page_form" action="<%=request.getContextPath() %>/DeptInfo/addSave" method="post" onSubmit="return checkSubmit()">
  ...
  <tr>
  <td width="60%" height="30"><IMG height=14 src="<%=request.getContextPath() %>/static/images/book1.gif" width=20>&nbsp;<u>添加部门信息</u></td>
  ...
  <table width="98%" border="0" align="center" cellpadding="2" cellspacing="2" id="needset" style="border:1px solid #cfcfcf;background:#ffffff;">
      ...
      <table width="800" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td ><input name="deptName" type="text" id="deptName" maxlength="16" onblur="isChinese(this,deptName);"/><span style="color:red;">*</span></td>
        </tr>
      </table>      </td>
  	</tr>
  	<tr>
