...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body class="main_body">
		<form name="subForm" id="subForm"
			action="<%=request.getContextPath()%>/ClientInfo/addSave" method="post"
							...
							<tr>
								...
								<td>
									<input name="clientName" type="text" id="clientName"
										maxlength="10" size="30" required onblur="return isChinese(this,clientName)"/>&nbsp;&nbsp;<span style="color:red;">*</span>
								</td>
							</tr>
						</table>
					</td>
					...
					<td width="255" height="24" colspan="4" class="bline">
						<table width="800" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td>
									<r:htmlRadio type="SEX" id="sex" name="sex" value="1"
					...
					<td width="255" height="24" colspan="4" class="bline">
						<table width="800" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td>
									<input name="hobby" id="hobby" maxlength="20"
										size="30"  />
								</td>
							</tr>
						</table>
					...
					<td height="24" colspan="4" class="bline">
						<table width="800" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td>
									<textarea name="remark" rows="5" id="remark" maxlength="100"
