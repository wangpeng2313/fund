...
<form name="subForm" id="subForm" action="<%=request.getContextPath() %>/issue/addSave" method="post" onSubmit="return checkSubmit()">
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td width="60%" height="30"><IMG height=14 src="<%=request.getContextPath() %>/static/images/book1.gif" width=20>&nbsp;<u>添加发行方</u></td>
    ...
    <tr>
      <td width="255" height="24" colspan="4" class="bline"><table width="800" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td><input name="issueName" type="text" id="issueName" maxlength="64" size="30"  required onblur="return isChinese(this,issueName)"/>&nbsp;&nbsp;<span style="color:red;">*</span>
          </td>
        </tr>
      </table></td>
    </tr>
     <tr>
      <td width="255" height="24" colspan="4" class="bline"><table width="800" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td><input name="phone" type="number" id="phone" maxlength="11" size="30"  required minlength="11" style="height: 20px;width: 186px"/>&nbsp;&nbsp;<span style="color:red;">*</span>
          </td>
        </tr>
      </table></td>
    </tr>
