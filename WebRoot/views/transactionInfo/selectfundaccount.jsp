...
<script>
function selectFundAccount(aCard,aId){
	window.opener.closeSelect(aCard,aId);
	window.close();
}
</script>
<body class="main_body">
<form name='page_form' id="page_form" action='<%=request.getContextPath() %>/fundAccount/queryByName' method='post'>
