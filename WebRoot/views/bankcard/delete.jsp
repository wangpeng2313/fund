...
<form name="subForm" id="subForm" action="<%=request.getContextPath() %>/bankcard/deleteSave" method="post" onSubmit="return checkSubmit()">
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <img src="<%=request.getContextPath() %>/static/images/arrow.png" align="absmiddle">&nbsp;&nbsp;账户销户</td>
  </tr>
    <tr>
      <td width="60%" height="30"><IMG height=14 src="<%=request.getContextPath() %>/static/images/book1.gif" width=20>&nbsp;<u>账户挂失</u></td>
  ...
  <table width="98%"  border="0" align="center" cellpadding="2" cellspacing="2" id="needset" style="border:1px solid #cfcfcf;background:#ffffff;">
    <tr>
      <td width="255" height="24" colspan="4" class="bline"><table width="800" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="150" align="center"><strong>账户销户</strong> </td>
     ...
     <tr>
      <td width="255" height="24" colspan="4" class="bline"><table width="800" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td><input name="accno" type="number" id="accno" maxlength="11" size="30" value="${item.accno }" required/>&nbsp;&nbsp;<span style="color:red;">*</span>
          </td>
        </tr>
      </table></td>
    </tr>
      ...
      <td width="255" height="24" colspan="4" class="bline"><table width="800" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td>
           ...
           <input name="accpwd" type="password" id="accpwd" maxlength="11" size="30" value="${item.accpwd }"  required/>&nbsp;&nbsp;<span style="color:red;">*</span>
