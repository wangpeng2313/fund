...
<form name='page_form' id="page_form" action='<%=request.getContextPath() %>/ClientInfo/queryByName' method='post'>
    ...
    <td align='center' background='<%=request.getContextPath() %>/static/images/wbg.gif' bgcolor="#EEF4EA">
      <table width="800" height="32" border='0' cellpadding='0' cellspacing='0'>
        <tr height="30">
	        ...
	        <td width='30%' align="left"><input type='text' name='clientName' value='${item.clientName }'/></td>
...
<table width='100%'  border='0' align="center" cellpadding='1' cellspacing='1' bgcolor='#cfcfcf' style="margin-top:8px">
	<tr bgcolor="#E7E7E7" >
		<td height="28" colspan="22" background="<%=request.getContextPath() %>/static/images/tbg.gif" style="padding-left:10px;">
			<table width="100%">
		      <tr>
		        <td width="50%"><b>客户列表</b>&nbsp; </td>
	...
	<tr align='center' bgcolor="#FFFFFF" height="26" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';">
		...
		<td><a href="#" onClick="selectClient(${item.id},'${item.clientName }');">选择</a></td>
	</tr>
	</c:forEach>
