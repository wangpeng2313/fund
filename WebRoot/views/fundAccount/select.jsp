...
function selectDept(id,name){
	...
	<body class="main_body">
		<form name='page_form' id="page_form"
			action='<%=request.getContextPath()%>/ClientInfo/queryForByName'
			method='post'>
			<table width='98%' id="condition_table" border='0' cellpadding='1'
				...
				<tr bgcolor='#EEF4EA'>
					<td align='center'
						...
						bgcolor="#EEF4EA">
						<table width="800" height="32" border='0' cellpadding='0'
							cellspacing='0'>
							<tr height="30">
								...
								<td width='30%' align="left">
									<input type='text' name='clientName' value='${item.clientName }' />
								</td>
			...
			<table width='98%' border='0' align="center" cellpadding='1'
				cellspacing='1' bgcolor='#cfcfcf' style="margin-top: 8px">
				<tr bgcolor="#E7E7E7">
					<td height="28" colspan="22"
				...
				<c:forEach var="item" items="${items}" varStatus="index">
					<tr align='center' bgcolor="#FFFFFF" height="26"
						...
						<td>
							<a href="#"
								onClick="selectDept(${item.id},'${item.clientName }');">选择</a>
						</td>
					</tr>
				</c:forEach>
				<tr align="right" bgcolor="#F9FCEF">
					<td height="36" colspan="22" align="center">
