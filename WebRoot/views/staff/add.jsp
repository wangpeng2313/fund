...
function selectDept(){
	...
	var url = "<%=request.getContextPath()%>/staff/selectForPageList";
...
<form name="subForm" id="subForm" action="<%=request.getContextPath() %>/staff/addSave" method="post" onSubmit="return checkSubmit()">
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td width="60%" height="30"><IMG height=14 src="<%=request.getContextPath() %>/static/images/book1.gif" width=20>&nbsp;<u>添加员工信息</u></td>
    ...
    <tr>
      <td width="255" height="24" colspan="4" class="bline"><table width="800" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td><input name="staffName" type="text" id="staffName" maxlength="64" size="30"  required onblur="return isChinese(this,staffName)"/>&nbsp;&nbsp;<span style="color:red;">*</span>
          </td>
        </tr>
      </table></td>
    </tr>
    <tr>
      <td width="255" height="24" colspan="4" class="bline"><table width="800" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td><input name="testFile" id="testFile" type="text" readonly="readonly"/><a href="javascript:selectFile();">请选择文件</a>&nbsp;&nbsp;<span style="color:red;">*</span>
          </td>
        </tr>
      </table></td>
    </tr>
     <tr>
      <td width="255" height="24" colspan="4" class="bline"><table width="800" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td>
           <input id="deptName" type="text" readonly="readonly"/><input name="deptId" type="hidden" id="deptId" maxlength="64" size="30" value="0"/> [<a href="javascript:selectDept();">选择部门名称</a>]&nbsp;&nbsp;<span style="color:red;">*</span>
          </td>
        </tr>
      </table></td>
    </tr>
   <tr>
      <td width="255" height="24" colspan="4" class="bline"><table width="800" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td><input name="tel" type="number" id="tel" maxlength="11" size="30"  required minlength="11" />&nbsp;&nbsp;<span style="color:red;">*</span>
          </td>
        </tr>
      </table></td>
    </tr>
     <tr>
      <td width="255" height="24" colspan="4" class="bline"><table width="800" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td>
          <r:htmlRadio type="SEX" id="sex" name="sex" value="1" html="onclick='test(111)'"/>
        ...
        <tr>
          ...
          <td>
									...
									<input name="cardNo" type="number" id="cardNo" maxlength="18"
										size="30" minlength="18" required />&nbsp;&nbsp;<span style="color: red;">*</span>
							...
							<tr>
								...
								<td>
									<input name="email" type="email" id="email" maxlength="64"
										size="30" required />&nbsp;&nbsp;<span style="color: red;">*</span>
								</td>
							</tr>
						</table>
					</td>
					...
					<td width="255" height="24" colspan="4" class="bline">
						<table width="800" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td>
									<input name="bankNo" type="number" id="bankNo" maxlength="19"
										size="30" minlength='16' required />&nbsp;&nbsp;<span style="color: red;">*</span>
								</td>
							</tr>
						</table>
					</td>
