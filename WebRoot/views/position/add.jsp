...
$().ready(function() {
	...
	<body class="main_body">
		<form name="subForm" id="subForm" action="<%=request.getContextPath()%>/position/addSave"
					...
					<td width="255" height="24" colspan="4" class="bline">
						<table width="800" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td>
									<input name="positionName" type="text" id="positionName" maxlength="64" required onblur="return isChinese(this,positionName)"/>
					...
					<td height="24" colspan="4" class="bline">
						<table width="800" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td>
									<input name="wage" type="number" id="wage" maxlength="16" required/>
									&nbsp;&nbsp;<span style="color:red;">*</span>
								</td>
							</tr>
						</table>
					...
					<td height="24" colspan="4" class="bline">
						<table width="800" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td>
									<input name="subsidyWage" type="number" id="subsidyWage" maxlength="16" required/>
									&nbsp;&nbsp;<span style="color:red;">*</span>
								</td>
							</tr>
						</table>
