...
<body>
	<form id="inputForm" action="${ctx}/register/addSave" method="post" class="form-horizontal">
		<fieldset>
			...
			<div class="form-actions">
				...
				<input id="cancel_btn" class="btn" type="button" value="返回" onclick="javascript:window.history.go(-1);return false;"/>
			</div>
		</fieldset>
	</form>
</body>
