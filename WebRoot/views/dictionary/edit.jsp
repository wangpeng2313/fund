...
<form name="subForm" id="subForm" action="<%=request.getContextPath() %>/dictionary/editSave" method="post" onSubmit="return checkSubmit()">
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
   <tr>
    ...
    <tr>
      <td width="60%" height="30"><IMG height=14 src="<%=request.getContextPath() %>/static/images/book1.gif" width=20>&nbsp;<u>修改字典编码</u></td>
    ...
    <tr>
      <td width="255" height="24" colspan="4" class="bline"><table width="800" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td><input type="hidden" name="dictionaryId" value="${items.dictionaryId}" /><input name="typeCode" type="hidden" id="typeCode" value="${items.typeCode}"/>${items.typeCode}<span style="color:red;">*</span>
          </td>
        </tr>
      </table></td>
    </tr>
    <tr>
      ...
      <table width="800" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td ><input name="key" type="number" id="key" value="${items.key}" maxlength="16" required/><span style="color:red;">*</span></td>
        </tr>
      </table></td>
  </tr>
  <tr>
      ...
      <table width="800" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td > 
           <input name="value" type="text" id="value" value="${items.value}" maxlength="16" required/><span style="color:red;">*</span>
          </td>
        </tr>
      </table></td>
  </tr>
  <tr>
      ...
      <table width="800" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td >
           <input name="parentId" type="number" id="parentId" maxlength="16" value="${items.parentId}" required/><span style="color:red;">*</span>
          </td>
        </tr>
      </table></td>
  </tr>
  <tr>
      ...
      <table width="800" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td >
           <input name="sort" type="number" id="sort" maxlength="16" value="${items.sort}" required/>&nbsp;&nbsp;<span style="color:red;">*</span>
          </td>
        </tr>
      </table></td>
  </tr>
  <tr>
      ...
      <table width="800" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td><textarea name="remark" rows="5" id="remark" style="width:80%;height:50px" >${items.remark}</textarea></td>
        </tr>
      </table></td>
  </tr>
  </table>
